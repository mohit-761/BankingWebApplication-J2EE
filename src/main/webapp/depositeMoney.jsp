...
<body>
		...
		<div class="navbar">
			...
			<div class="navbar-links">
				<ul>
					...
					<li><a class="active" href="depositeMoney.jsp">deposite</a></li>
	...
	<div class="main">
		...
		<form action="DepositeMoney" method="post">
			...
			<section>
				<label for="deposite_amount">enter amount to deposite:</label>
	...
	<script>
      document.querySelector("button[type='submit']").addEventListener("click", (event) => {
          ...
          const amount = document.querySelector("input[name='deposite_amount']").value;
